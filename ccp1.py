# =================================
# ============================================================
# IF RUNNING STANDALONE ON EXISTING CSV:
# ============================================================
# Use the code block below if you want to add this column
# to your already-generated Predictive_Maintenance_KPI_Output.csv
# WITHOUT regenerating the full dataset.
# ============================================================

# STANDALONE_MODE = False  # ← set to True to run standalone
